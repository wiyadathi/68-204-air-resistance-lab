...
public class AirplaneController2 : MonoBehaviour
{
    ...
    [Header("Aerodynamics")]
    public float liftPower = 0.02f;
    public float dragFactor = 0.02f;

    [Header("Control Settings")]
    public float pitchPower = 50f;       // ความเร็วในการเชิดหัว (W/S)
    public float rollPower = 40f;        // ความเร็วในการเอียงปีก (A/D)
